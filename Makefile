#############################################################################
# Makefile for building: digitalblock-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Feb 16 02:38:07 2016
# Project:  DigitalBlock-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile DigitalBlock-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/DigitalBlock/src/leveldb/libleveldb.a /tmp/DigitalBlock/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: DigitalBlock-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile DigitalBlock-qt.pro
...
/tmp/DigitalBlock/src/leveldb/libleveldb.a: FORCE
	cd /tmp/DigitalBlock/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/DigitalBlock/build/build.h: FORCE
	cd /tmp/DigitalBlock; /bin/sh share/genbuild.sh /tmp/DigitalBlock/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/Digitalblock-16.png \
		src/qt/res/icons/Digitalblock-80.png \
